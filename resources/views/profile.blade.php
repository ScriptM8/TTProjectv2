            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        @else
                            <a href="/profile/delete/{{ $user->id }}" class="btn btn-info" role="button">Delete
                                profile</a>
                        @endif
                    ...
                    <div class="col">
                        ...
                        <form action="/profile" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <small id="fileHelp" class="form-text text-muted">Size of image should not be more than
                                    2MB.</small>
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            @foreach($feedbacks as $feed)
                                <div class="card-text">
                                    Rating: {{$feed->rating}}, {{$feed->description}}
                                </div>
                            @endforeach
                        </div>
                    </div>
